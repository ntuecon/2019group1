...
H = S.optH(Pa, Pb, w)
print "at equilibrium there will be %f amounts of a at price %d and %f amounts of b at price %d, workers will work at the wage of %f and be payed %d per hour." % (Qa, Pa, Qb, Pb, H, w)
